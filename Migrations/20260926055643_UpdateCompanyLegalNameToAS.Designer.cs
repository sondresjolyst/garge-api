...
namespace garge_api.Migrations
{
    ...
    [Migration("20260926055643_UpdateCompanyLegalNameToAS")]
    partial class UpdateCompanyLegalNameToAS
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("User", b =>
                {
                    ...
                    b.Property<DateTime?>("DataRetentionOptOutAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("garge_api.Models.Admin.DailyStatSnapshot", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("TotalAutomations")
                        .HasColumnType("integer");

                    b.Property<int>("TotalSensors")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("garge_api.Models.Anonymized.AnonymizedReading", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("AnonymizedReadings");
                });

            modelBuilder.Entity("garge_api.Models.Anonymized.AnonymizedSeries", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("garge_api.Models.Pairing.PairingToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("ConsumedByParentName")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
            ...
            modelBuilder.Entity("garge_api.Models.Sensor.SensorOwnershipPeriod", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("SensorOwnershipPeriods");
                });
            ...
            modelBuilder.Entity("garge_api.Models.Sensor.UserSensorVoltageThreshold", b =>
                {
                    ...
                    b.Property<double>("CriticalVoltage")
                        .HasColumnType("double precision");

                    b.Property<double>("WarningVoltage")
                        .HasColumnType("double precision");
                    ...
                    b.ToTable("UserSensorVoltageThresholds");
                });
            ...
            modelBuilder.Entity("garge_api.Models.Switch.SwitchOwnershipPeriod", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("SwitchId", "StartedAt");

                    b.HasIndex("UserId", "SwitchId");

                    b.ToTable("SwitchOwnershipPeriods");
                });
            ...
            modelBuilder.Entity("garge_api.Models.Anonymized.AnonymizedReading", b =>
                {
                    b.HasOne("garge_api.Models.Anonymized.AnonymizedSeries", "Series")
                        .WithMany()
            ...
            modelBuilder.Entity("garge_api.Models.Shop.Invoice", b =>
                {
                    ...
                    b.HasOne("garge_api.Models.Subscription.Subscription", "Subscription")
                        .WithMany()
